...
<p>
  EmailAIAssistant, is a desktop application that helps you to filter emails using Lamma3 with Ollama. It is built using Electron, React, Redux, and Typescript. It is a fork of the Electron React Boilerplate.
